...
export default {
    ...
    methods: {
        ...
        findAllProvince() {
            dictApi.getDictList(86).then((response) => {
                console.log('所有省份数据 -- ', response);
                this.provinceList = response.data;
            });
        },
        provinceChanged() {
            dictApi.getDictList(this.searchObj.provinceCode).then((response) => {
                console.log('所有城市数据 -- ', response);
